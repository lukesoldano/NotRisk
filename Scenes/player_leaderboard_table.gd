...
func add_entry(player_color: Color, num_countries: int, num_armies: int, num_reinforcements: int) -> void:
   ...
   entry.set_values(player_color, num_countries, num_armies, num_reinforcements)
   
func update_entry(index: int, num_countries: int, num_armies: int, num_reinforcements: int) -> void:
   assert(index < self.__entries.size(), "Invalid index, out of bounds of table")
   
   self.__entries[index].update_values(num_countries, num_armies, num_reinforcements)
